  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const sanitizedSettings = {
        ...settings,
        platform_name: sanitizeHtml(settings.platform_name),
        logo_url: sanitizeHtml(settings.logo_url),
        favicon_url: sanitizeHtml(settings.favicon_url)
      };

      const payload = { ...sanitizedSettings, group: 'general' };
      if (!settings.id) {
      ...
      updateSettingsOptimistic(sanitizedSettings);
