...
import { getBroadcastStatus, getRecipientStatus } from "@/lib/broadcasts/broadcast-status";
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        ...
        if (!cancelled) {
          setError(err instanceof Error ? err.message : "Erro ao carregar transmissão");
        }
      } finally {
          ...
          <Button
            ...
            title={
              broadcast.status === "sending"
                ? "Não é possível excluir durante o envio"
