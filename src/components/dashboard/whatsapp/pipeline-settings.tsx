...
const DEFAULT_PIPELINE = {
  id: "whatsapp-default-pipeline",
  name: "Pipeline WhatsApp",
};
...
export function PipelineSettings({
  ...
  // supabase is imported from integrations

  const [name, setName] = useState(DEFAULT_PIPELINE.name);
            ...
            <div className="flex items-center gap-3 rounded-lg border border-red-500/30 bg-red-500/10 p-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Isso irá arquivar todos os negócios neste pipeline. Esta ação não pode ser desfeita.
                </p>
              </div>
            </div>
